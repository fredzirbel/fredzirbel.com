...
export default function NotFound() {
  return (
    <div className="flex min-h-dvh flex-col items-start justify-center px-6 md:px-12">
      <p className="mb-4 font-mono text-xs uppercase tracking-widest text-trace">404</p>
      <h1
      ...
      <Link
        href="/"
        className="rounded-full bg-ink px-6 py-3 text-sm font-medium text-void transition-colors duration-(--duration-fast) hover:bg-signal hover:text-ink"
      >
        Back home
      </Link>
    </div>

...
const roles = [
  {
    ...
    bullets: [
      ...
      'Execute remediation on live incidents under a dual-authorization workflow, including host isolations, credential resets, session revocations, email deletions, and file quarantines.',
  ...
  },
  {
    ...
    bullets: [
      ...
      'Seconded and verified remediation actions initiated by principal analysts by confirming scope, target accuracy, and justification before execution.',
